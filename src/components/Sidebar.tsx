    ...
    <AnimatePresence>
      {open && (
        <motion.aside
          ...
          className="fixed inset-y-0 left-0 z-40 w-72 max-w-full bg-white shadow-xl flex flex-col border-r border-gray-200 md:relative md:translate-x-0 md:w-72 md:z-10 md:shadow-none md:border-r transition-all"
